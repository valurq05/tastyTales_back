...
public class DatoController {
	...
	@PutMapping(value="datos", produces = MediaType.APPLICATION_JSON_VALUE )
	public ResponseEntity<Dato> updateDatos(@RequestBody Dato dato) {
		service.upDato(dato);
		return new ResponseEntity<Dato>(dato, HttpStatus.OK);			
	}
}
